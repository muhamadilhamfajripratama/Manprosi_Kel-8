...
<body class="bg-cream font-sans text-gray-700 h-screen flex overflow-hidden">
    ...
    <aside class="w-[260px] bg-primary-dark flex flex-col shrink-0 text-white shadow-xl z-30">
        ...
        <nav class="flex-1 overflow-y-auto sidebar-scroll py-6 px-4 flex flex-col gap-1.5">
            ...
            {{-- Penanaman (Aktif) --}}
            <a href="{{ route('penanaman') }}" class="flex items-center gap-3 px-3 py-2.5 bg-primary-mid border-l-[3px] border-white text-white font-semibold rounded-r-lg transition-colors">
                ...
                <div class="batch-card bg-white rounded-2xl shadow-sm border-t-[6px] {{ $batch->status == 'aktif' ? 'border-primary-dark' : 'border-gray-400' }} p-6 flex flex-col justify-between"
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-2 gap-y-4 gap-x-2 mb-6">
                            ...
                            <div>
                                <p class="text-[11px] text-gray-400 mb-0.5">Biaya Bibit</p>
                                <p class="text-[13px] font-semibold text-gray-800">Rp {{ number_format($batch->biaya_bibit ?? 0, 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
            ...
            <form action="{{ route('penanaman.store') }}" method="POST" id="formPenanaman" class="p-6 max-h-[85vh] overflow-y-auto">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <input type="text" name="komoditas" required placeholder="Misal: Bawang Putih Bonggol" class="w-full border border-gray-200 rounded-[8px] px-3 py-2.5 text-sm focus:outline-none focus:border-primary-mid">
                    </div>
                </div>
                ...
                <div class="bg-gray-50 border border-gray-200 rounded-[12px] p-4 mb-4">
                    <h4 class="text-[13px] font-bold text-gray-800 mb-3 border-b pb-2">Detail Pembibitan & Biaya</h4>
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-3">
                        <div>
                            <label class="block text-[11px] font-bold text-gray-500 mb-1">Jumlah Bibit</label>
                            <input type="number" step="0.01" name="jumlah_bibit" required placeholder="Misal: 50" class="w-full border border-white rounded-[8px] px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary-mid">
                        </div>
                        <div>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="jarak_tanam_cm" required placeholder="25x25 cm" class="w-full border border-white rounded-[8px] px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary-mid">
                        </div>
                        <div>
                            <label class="block text-[11px] font-bold text-gray-500 mb-1">Total Biaya Bibit (Rp)</label>
                            <input type="number" name="biaya_bibit" required placeholder="Misal: 150000" class="w-full border border-white rounded-[8px] px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-primary-mid">
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        document.querySelectorAll('.btn-edit-penanaman').forEach(button => {
            button.addEventListener('click', function(e) {
                ...
                if(document.querySelector('[name="biaya_bibit"]'))         document.querySelector('[name="biaya_bibit"]').value = this.dataset.biaya;
