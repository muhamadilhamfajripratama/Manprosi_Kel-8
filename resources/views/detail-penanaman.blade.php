        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
                ...
                <div class="space-y-3 flex-1">
                    ...
                    {{-- 0. BIAYA PEMBIBITAN (BARU DITAMBAHKAN) --}}
                    <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 rounded-full bg-purple-100 text-purple-600 flex items-center justify-center"><i class="ph ph-plant"></i></div>
                            <span class="text-[13px] font-bold text-gray-700">Biaya Pembibitan</span>
                        </div>
                        <span class="text-[14px] font-bold text-gray-900">Rp {{ number_format($batch->biaya_bibit ?? 0, 0, ',', '.') }}</span>
                    </div>
                ...
                <div class="mt-6 pt-4 border-t border-gray-100 flex justify-between items-center">
                    ...
                    @php
                        $grandTotalKeseluruhan = ($totalBiayaKeseluruhan ?? 0) + ($batch->biaya_bibit ?? 0);
                    @endphp
                    <span class="text-[20px] font-bold text-red-500">Rp {{ number_format($grandTotalKeseluruhan, 0, ',', '.') }}</span>
                </div>
            </div>
